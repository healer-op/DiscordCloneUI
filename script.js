...
// settings svg
const SETTINGS = `<svg aria-hidden="false" viewBox="0 0 24 24" class="settings">
    <path fill-rule="evenodd" clip-rule="evenodd"
...
function srv(){
    document.getElementById("srname").innerHTML="DiscordClone"
}

function srv1(){
    document.getElementById("srname").innerHTML="Loading🔃";
    setTimeout(function(){
        document.getElementById("srname").innerHTML="⭐Made By";
      }, 500);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="❤️Healerop";
      }, 1000);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="🚩Start My Repo";
      }, 2000);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="🪟For More Awesome";
      }, 3000);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="📦Projects";
      }, 4000);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="🗃️And Fun";
      }, 5000);
    setTimeout(function(){
        document.getElementById("srname").innerHTML="Discord Clone";
      }, 6000);
}


function change() {
    var imgurl=prompt("Enter And Image Url");
    document.getElementById("pfp").src = imgurl;
    var name=prompt("Enter your discord name");
    document.getElementById("nameu").innerHTML=name;
    var tag=prompt("Enter You #4531 without #");
    document.getElementById("tagu").innerHTML="#"+tag;

}
/*----------------Audio Files---------------*/
const ping = new Audio('https://github.com/healer-op/HealCloud/blob/main/mp3/ping.mp3?raw=true');
const defend = new Audio('https://audiosoundclips.com/wp-content/uploads/2019/11/Deafensound.mp3');
const discordo = new Audio('https://github.com/healer-op/HealCloud/blob/main/mp3/Discordo.mp3?raw=true');
const pingtrap = new Audio('https://github.com/healer-op/HealCloud/blob/main/mp3/Exyl%20-%20Ping!%20DISCORD%20Notification%20Trap%20Remix.mp3?raw=true');
const calltrap = new Audio('https://github.com/healer-op/HealCloud/blob/main/mp3/Discord%20Call%20Trap%20Remix%20(Discord%20Drip%20Meme).mp3?raw=true');
const call = new Audio('https://audiosoundclips.com/wp-content/uploads/2019/11/Outgoingring.mp3');
